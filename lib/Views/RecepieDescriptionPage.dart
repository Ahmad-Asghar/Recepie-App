...
class RecepieDescriptionPage extends StatelessWidget {
  int indexx;
  RecepieDescriptionPage({Key? key, required this.indexx}) : super(key: key);
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(
                            ...
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(list.eggRecepies[this.indexx],
                                style: TextStyle(
                          ...
                          Text(
                            "Learn how to make perfect "+list.eggRecepies[this.indexx]+" with this quick recepie..",
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 2.24.h,
                            ),
